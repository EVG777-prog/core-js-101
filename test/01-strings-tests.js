...
describe('01-strings-tasks', () => {
  ...
  it.optional('extractEmails should extract emails from string list delimeted by semicolons', () => {
    assert.deepEqual(
      tasks.extractEmails('angus.young@gmail.com;brian.johnson@hotmail.com;bon.scott@yahoo.com'), ['angus.young@gmail.com', 'brian.johnson@hotmail.com', 'bon.scott@yahoo.com'],
    );
    assert.deepEqual(
      tasks.extractEmails('info@gmail.com'), ['info@gmail.com'],
    );
  });
